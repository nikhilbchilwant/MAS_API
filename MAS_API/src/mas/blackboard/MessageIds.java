...
public class MessageIds {
		...
		public static String MachineService = "Machine";
		
		public static String CustomerService = "Customer";
		
		public static String LocalScheulingService = "Local-Scheduler";
		
		public static String ScheulingService = "Global-Scheduler";
		
		public static String MaintenanceService = "Maintenance";
